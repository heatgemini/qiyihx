...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{__PW_PATH__}{__ADMIN_FILE__}?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">新建图文素材</span></div>
        </div>
			...
			<div class="editor-left">
				...
				<div class="all-tuwen">
					<div class="big-tuwen">
						...
						<img id="img_0" src="{__PW_PATH__}addons/wechat/admin/template/images/no_cover_pic.png" /><span id="title_span_0">标题</span>
				...
				<table width="100%" class="insert-tab">
					<tbody>
						...
						<tr class="formtr">
							...
							<td class="formtd"><input type="text" size="32" name="p_author" value="{__WECHAT_NAME__}" id="p_author" class="common-text"></td>
						</tr>
						<tr class="formtr">
