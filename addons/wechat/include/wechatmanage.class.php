...
class WeChatManage
{
	...
	*/
	...
	static public function editMediaMaterial($Title,$Author,$Description,$PicUrl,$thumb_media_id,$content,$urls,$up_group_id=0)
	{
		if(!$Title)
		{
			return -1;
	...
	static public function setMaterial($info=array(),$id=0)
	{
		return MySql::update(DB_PRE.self::$mMaterialTable,$info,"`id`=".intval($id));
	}
