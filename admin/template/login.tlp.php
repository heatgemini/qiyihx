...
<head>
    ...
    <link href="{__PW_PATH__}admin/template/css/login.css" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function(){
		$('#adminlogin').submit(function(){
			...
			if($.trim($('#captchacode').val()).length!={__CAPTCHA_LEN__}){
            ...
            <form action="" method="post" name="adminlogin" id="adminlogin">
                ...
                <ul class="admin_items">
					...
					<li>
						...
						<img class="captchaimg" id="captchaimg"  onClick="getCaptcha('captchaimg')" src="{__PW_PATH__}api/captcha/index.php?t={mt_rand()}" /> 
